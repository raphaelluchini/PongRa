package org.papervision3d.core.animation.channel {
	 ...
	 * @author Tim Knip
	 * 
	 * @modifications: updateSmoothlyToTime() added by Pablo Bandin.
	 */ 
	public class MatrixChannel3D extends AbstractChannel3D
	{
		...
		public override function updateSmoothlyToTime(time:Number, fragment:Number, doitFast:Boolean = false):void
		{
			super.updateSmoothlyToTime(time, fragment);
			target.gotoTransform(currentKeyFrame.output[0], nextKeyFrame.output[0], doitFast?1:(time-Math.floor(time)));
		}
	}
}